...
readme_content = """# DevOps Specialist — Pipeline Generator
...
# Cria o arquivo ZIP
with zipfile.ZipFile("project_docs.zip", "w") as zipf:
    zipf.write("README.md")

print("Arquivo README.md criado e compactado em project_docs.zip")
